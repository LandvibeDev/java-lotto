...
public enum Messages {
	...
	RECEIPT_TITLE("당첨 통계\n---"),
	WINNING_MESSAGE_FORMAT_FIRST("%d개 일치 (%s) - %d개"),
	WINNING_MESSAGE_FORMAT_SECOND("%d개 일치, 보너스 볼 일치 (%s) - %d개"),
	WINNING_MESSAGE_FORMAT_THIRD("%d개 일치 (%s) - %d개"),
	WINNING_MESSAGE_FORMAT_FOURTH("%d개 일치 (%s) - %d개"),
	WINNING_MESSAGE_FORMAT_FIFTH("%d개 일치 (%s) - %d개"),
